  ...
  return (
    <div className="min-h-screen bg-background">
      <AppHeader
        ...
        backLabel="Temas"
        rightSlot={
          <Link href={`/student/topics/${detail.topic.slug}/practice`} className="inline-flex items-center justify-center rounded-full bg-primary hover:bg-secondary text-white px-4 py-2 text-sm font-medium transition-colors">
            Practicar ahora
          </Link>
        }
      />
          ...
          <article className="bg-white rounded-2xl border border-foreground/10 p-6">
            <div className="flex items-center justify-between gap-4 mb-5">
              ...
              {detail.questionCount > 0 ? (
                <Link href={`/student/topics/${detail.topic.slug}/practice`} className="text-sm text-primary hover:text-secondary transition-colors">
                  Ir a práctica
                </Link>
              ) : null}
            </div>
