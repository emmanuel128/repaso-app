                    ...
                    {area.topics.map((topic) => (
                      <article key={topic.id} className="bg-white rounded-2xl border border-foreground/10 shadow-sm p-6 flex flex-col">
                        ...
                        <div className="mt-6 flex items-center justify-end gap-4">
                          <Link href={`/student/topics/${topic.slug}`} className="inline-flex items-center justify-center rounded-full bg-primary hover:bg-secondary text-white px-4 py-2 text-sm font-medium transition-colors">
                            Abrir tema
                          </Link>
                        </div>
                      </article>
